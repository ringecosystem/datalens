...
pub(crate) const SOLANA_ADDRESS_KIND: &str = "solana_address";
pub(crate) const SOLANA_PROGRAM_KIND: &str = "solana_program";
pub(crate) const SOLANA_SIGNATURE_KIND: &str = "solana_signature";
pub(crate) const FINALIZED: SolanaCommitment = SolanaCommitment::Finalized;
