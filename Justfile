...
indexer-postgres-e2e:
  DATALENS_REQUIRE_POSTGRES_TEST_URL=1 DATALENS_POSTGRES_TEST_URL="${DATALENS_POSTGRES_TEST_URL:-postgres://datalens:datalens@127.0.0.1:5432/datalens_test}" cargo test -p datalens-indexer --test postgres_output -- --test-threads=1
